...
# Resolve relative path to trained model
...
app = FastAPI(
    title="Mental Health & Social Media Prediction API",
    description="FastAPI machine learning backend predicting student mental health score based on screen usage, sleep, study, and stress habits.",
    version="1.0.0"
)
...
def greet():
    return {
        "message": "Welcome to Mental Health Prediction API",
        "status": "online",
        "version": "1.0.0"
    }
